    ...
    public static func response(
        ...
        case .authenticate(let authenticate):
            do {
                ...
                let response = try await Identity.Authentication.API.providerResponse(
        ...
        case .mfa:
            ...
            do {
                ...
                throw Abort(
                    .notImplemented,
                    reason: "MFA endpoints not yet implemented in Provider"
                )
            } catch {
                await rateLimitClient.recordFailure()
                throw error
        ...
        case .oauth:
            ...
            do {
                ...
                throw Abort(
                    .notImplemented,
                    reason: "OAuth endpoints not yet implemented in Provider"
                )
            } catch {
                await rateLimitClient.recordFailure()
                throw error
