        ...
        return .init(
                ...
                client: .init(
                    current: {
                        ...
                        do {
                            ...
                            logger.info(
                                "Logout attempted for non-existent identity - clearing session"
                            )
                        }
                    ...
                    all: {
                        do {
                            ...
                            @Dependency(\.logger) var logger
                            logger.info(
                                "Logout all attempted for non-existent identity - session already invalid"
                            )
                        }
                    }
                ),
            ...
            delete: .init(
                client: .live(
                    ...
                    sendDeletionConfirmationNotification: emailConfig
            ...
            email: .init(
                change: .init(
                    client: .live(
                        ...
                        sendEmailChangeRequestNotification: emailConfig
