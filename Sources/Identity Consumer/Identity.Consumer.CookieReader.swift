...
extension Identity.Consumer {
    ...
    public struct CookieReader: Sendable {
        ...
        public func identityCookies(in request: Request) -> Bool {
            accessToken(from: request) != nil || refreshToken(from: request) != nil
        ...
        public func forwardCookies(
            ...
            if !cookieStrings.isEmpty {
                urlRequest.setValue(
                    cookieStrings.joined(separator: "; "),
        ...
        public func clearAll(headers: inout HTTPHeaders) {
            ...
            headers.add(
                name: .setCookie,
                value:
                    "\(Identity.Cookies.Names.accessToken)=; Path=/; Max-Age=0; HttpOnly; SameSite=Strict"
            )
            headers.add(
                name: .setCookie,
                value:
                    "\(Identity.Cookies.Names.refreshToken)=; Path=/; Max-Age=0; HttpOnly; SameSite=Strict"
            )
            headers.add(
                name: .setCookie,
                value:
                    "\(Identity.Cookies.Names.reauthorizationToken)=; Path=/; Max-Age=0; HttpOnly; SameSite=Strict"
            )
        }
        ...
        public func debugDescription(for request: Request) -> String {
            ...
            if accessToken(from: request) != nil {
                parts.append("access_token=<redacted>")
            }
            if refreshToken(from: request) != nil {
                parts.append("refresh_token=<redacted>")
            }
            if reauthorizationToken(from: request) != nil {
