...
extension Identity.Backend.Configuration {
    ...
    public struct Email: Sendable {
        ...
        public init(
            ...
            sendEmailChangeConfirmation: @escaping @Sendable (EmailAddress, EmailAddress, String) async throws -> Void,
            sendEmailChangeRequestNotification: @escaping @Sendable (EmailAddress, EmailAddress) async throws -> Void,
            ...
            onIdentityCreationSuccess: @escaping @Sendable ((id: Identity.ID, email: EmailAddress)) async throws -> Void = { _ in }
        ) {
