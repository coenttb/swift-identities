...
extension Identity.Token {
  ...
  public struct Record: Codable, Equatable, Identifiable, Sendable {
    ...
    public struct TokenType: RawRepresentable, Codable, Hashable, QueryBindable, Sendable,
...
extension Identity.Token.Record {
  ...
  package static func findByIdentityAndType(_ identityId: Identity.ID, _ type: TokenType) -> Where<
