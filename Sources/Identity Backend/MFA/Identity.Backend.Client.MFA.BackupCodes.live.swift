...
extension Identity.MFA.BackupCodes.Client {
    public static func live(
        ...
        return Identity.MFA.BackupCodes.Client(
            regenerate: { () throws(Identity.MFA.BackupCodes.Client.Error) in
                do {
                    ...
                    throw .regenerate(reason: "\(error)")
                }
            },

            verify: { code, sessionToken throws(Identity.MFA.BackupCodes.Client.Error) in
                do {
            ...
            remaining: { () throws(Identity.MFA.BackupCodes.Client.Error) in
                do {
