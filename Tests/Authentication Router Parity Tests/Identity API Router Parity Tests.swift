    ...
    static func routes() throws -> [(name: String, route: Identity.API)] {
        [
            ...
            (
                ...
                .authenticate(.credentials(.init(username: Fixed.email, password: Fixed.password)))
            ),
            ...
            (
                "create.request",
                .create(.request(.init(email: Fixed.email, password: Fixed.password)))
            ),
            ...
            (
                ...
                .password(.reset(.confirm(.init(token: Fixed.token, newPassword: Fixed.password))))
            ),
            (
                ...
                .password(
                    .change(
                        .request(
                            .init(currentPassword: Fixed.password, newPassword: Fixed.password)
                        )
                    )
                )
            ),
            ...
            (
                "mfa.totp.verify",
                .mfa(.totp(.verify(.init(code: Fixed.code, sessionToken: Fixed.sessionToken))))
            ),
            (
                "mfa.totp.disable",
                .mfa(.totp(.disable(.init(reauthorizationToken: Fixed.reauthToken))))
            ),
            // MFA — SMS
            ...
            (
                "mfa.sms.verify",
                .mfa(.sms(.verify(.init(code: Fixed.code, sessionToken: Fixed.sessionToken))))
            ),
            (
                    ...
                    .sms(
                        .updatePhoneNumber(
                            .init(
                                ...
                                reauthorizationToken: Fixed.reauthToken
                            )
                        )
                    )
                )
            ...
            (
                "mfa.sms.disable",
                .mfa(.sms(.disable(.init(reauthorizationToken: Fixed.reauthToken))))
            ),
            // MFA — Email
            ...
            (
                "mfa.email.verify",
                .mfa(.email(.verify(.init(code: Fixed.code, sessionToken: Fixed.sessionToken))))
            ),
            (
                ...
                .mfa(
                    .email(
                        .updateEmail(
                            .init(email: Fixed.newEmail, reauthorizationToken: Fixed.reauthToken)
                        )
                    )
                )
            ),
            (
                "mfa.email.disable",
                .mfa(.email(.disable(.init(reauthorizationToken: Fixed.reauthToken))))
            ),
            // MFA — WebAuthn
            ...
            (
                ...
                .mfa(
                    .webauthn(
                        .finishRegistration(
                            .init(credentialName: "parity-key", response: "{\"fixed\":true}")
                        )
                    )
                )
            ),
                ...
                .mfa(
                    .webauthn(
                        .finishAuthentication(
                            .init(response: "{\"fixed\":true}", sessionToken: Fixed.sessionToken)
                        )
                    )
                )
            ),
            ...
            (
                ...
                .mfa(
                    .webauthn(
                        .removeCredential(
                            .init(
                                credentialId: "fixed-credential-id",
                                reauthorizationToken: Fixed.reauthToken
                            )
                        )
                    )
            ...
            (
                ...
                .mfa(.webauthn(.disable(.init(reauthorizationToken: Fixed.reauthToken))))
            ),
            // MFA — Backup codes
            ...
            (
                ...
                .mfa(
                    .backupCodes(.verify(.init(code: Fixed.code, sessionToken: Fixed.sessionToken)))
                )
            ),
            ...
            (
                ...
                .mfa(
                    .verify(
                        .init(sessionToken: Fixed.sessionToken, method: .totp, code: Fixed.code)
                    )
                )
            ),
            // OAuth
            ...
            (
                "oauth.callback",
                .oauth(
                    .callback(.init(provider: Fixed.provider, code: Fixed.code, state: Fixed.state))
                )
            ),
